---
article_id: EFL-04-06
title: "Repair Spalls dan Defects sebelum Coating"
slug: "perbaikan-substrate-sebelum-epoxy"
...
date_modified: null
parent_topic: EFL-04
primary_intent: "Menyiapkan local repairs"
reader_community: "Lantai.id"
reader_address: "Teman Lantai.id"
final_route: "/artikel/perbaikan-substrate-sebelum-epoxy.html"
...
# Repair Spalls dan Defects sebelum Coating

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Repair Spalls dan Defects sebelum Coating”
...
- **Primary intent:** Menyiapkan local repairs
...
- **Scope boundary:** Structural/crack issues dimiliki EFL-10.
- **Final public route:** `/artikel/perbaikan-substrate-sebelum-epoxy.html`
- **Appointed CMS date:** `2025-10-05` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Repair Spalls dan Defects sebelum Coating**.
...
- **Tie back to this article:** Keep the explanation specific to “Repair Spalls dan Defects sebelum Coating”.
