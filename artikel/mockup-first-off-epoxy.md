---
article_id: EFL-13-04
title: "Mockup dan First-Off Approval"
slug: "mockup-first-off-epoxy"
description: "Menghasilkan area schedule, thickness zones, color/texture sample, mockup, dan evidence-led spec"
status: outline
publication_date: "2026-05-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EFL-13
primary_intent: "Menyetujui installation sample"
reader_community: "Lantai.id"
reader_address: "Sobat Lantai.id"
final_route: "/artikel/mockup-first-off-epoxy.html"
...
# Mockup dan First-Off Approval

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mockup dan First-Off Approval”
- **Reader and situation:** Menghasilkan area schedule, thickness zones, color/texture sample, mockup, dan evidence-led spec
- **Reader outcome:** Menghasilkan area schedule, thickness zones, color/texture sample, mockup, dan evidence-led spec
- **Primary intent:** Menyetujui installation sample
...
- **Scope boundary:** Bukan full performance certification.
- **Final public route:** `/artikel/mockup-first-off-epoxy.html`
- **Appointed CMS date:** `2026-05-03` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mockup dan First-Off Approval**.
...
- `EFL-13-02` → `/artikel/jadwal-sistem-epoxy-lantai.html` — Thickness Zones dan System Schedule
- `EFL-13-03` → `/artikel/sampel-warna-tekstur-epoxy.html` — Color, Texture, dan Slip Sample
- `EFL-13-05` → `/artikel/hitung-quantity-epoxy-lantai.html` — Quantity, Waste, dan Coverage Calculation
- `EFL-13-06` → `/artikel/spesifikasi-epoxy-berbasis-bukti.html` — Menulis Specification Berbasis Evidence
...
- **Tie back to this article:** Keep the explanation specific to “Mockup dan First-Off Approval”.
