---
article_id: EFL-12-02
title: "Mall dan Hotel Flooring"
slug: "epoxy-lantai-mall-hotel"
...
date_modified: null
parent_topic: EFL-12
primary_intent: "Menilai public-area requirements"
reader_community: "Lantai.id"
reader_address: "Teman Lantai.id"
final_route: "/artikel/epoxy-lantai-mall-hotel.html"
...
# Mall dan Hotel Flooring

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mall dan Hotel Flooring”
...
- **Primary intent:** Menilai public-area requirements
...
- **Scope boundary:** Slip/fire/odor claims need evidence.
- **Final public route:** `/artikel/epoxy-lantai-mall-hotel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mall dan Hotel Flooring**.
...
- `/mall` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Mall dan Hotel Flooring”.
