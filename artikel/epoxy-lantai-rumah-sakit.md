---
article_id: EFL-12-03
title: "Hospital Flooring"
slug: "epoxy-lantai-rumah-sakit"
...
date_modified: null
parent_topic: EFL-12
primary_intent: "Menyusun healthcare brief"
reader_community: "Lantai.id"
reader_address: "Teman Lantai.id"
final_route: "/artikel/epoxy-lantai-rumah-sakit.html"
...
- **Writer task:** Expand this file into one complete article answering: “Hospital Flooring”
...
- **Primary intent:** Menyusun healthcare brief
...
- **Scope boundary:** Tidak membuat hygiene/medical claims.
- **Final public route:** `/artikel/epoxy-lantai-rumah-sakit.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Hospital Flooring**.
...
- **Exact Markdown to insert:** `![Ilustrasi kontraktor lantai Rumah Sakit](/wp-content/uploads/2025/07/kontraktor-lantai-Rumah-Sakit.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `kontraktor lantai Rumah Sakit` as relevant content media; no pixels were inspected.
...
- `/rumah-sakit` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/rumah-sakit/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `EFL-12-01` → `/artikel/epoxy-lantai-kantor-retail.html` — Epoxy Flooring untuk Office dan Retail
- `EFL-12-02` → `/artikel/epoxy-lantai-mall-hotel.html` — Mall dan Hotel Flooring
- `EFL-12-04` → `/artikel/epoxy-lantai-stasiun-bandara.html` — Station dan Airport Flooring
- `EFL-12-05` → `/artikel/epoxy-lantai-lapangan-basket.html` — Sports Court dan Basketball Area
...
- **Tie back to this article:** Keep the explanation specific to “Hospital Flooring”.
