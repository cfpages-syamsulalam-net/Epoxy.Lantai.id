---
article_id: EFL-04-03
title: "Concrete Strength dan Surface Soundness"
slug: "kekuatan-permukaan-beton-epoxy"
...
date_modified: null
parent_topic: EFL-04
primary_intent: "Memeriksa substrate integrity"
reader_community: "Lantai.id"
reader_address: "Kawan Lantai.id"
final_route: "/artikel/kekuatan-permukaan-beton-epoxy.html"
...
# Concrete Strength dan Surface Soundness

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Concrete Strength dan Surface Soundness”
...
- **Primary intent:** Memeriksa substrate integrity
...
- **Scope boundary:** Acceptance criteria perlu evidence.
- **Final public route:** `/artikel/kekuatan-permukaan-beton-epoxy.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Concrete Strength dan Surface Soundness**.
...
- `/epoxy/polished-concrete/` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kontraktor-injeksi-beton-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kontraktor-injeksi-beton-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kontraktor-injeksi-beton-yalimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kontraktor-injeksi-beton-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `EFL-04-01` → `/artikel/assessment-substrate-epoxy.html` — Checklist Assessment Concrete Substrate
...
- **Tie back to this article:** Keep the explanation specific to “Concrete Strength dan Surface Soundness”.
