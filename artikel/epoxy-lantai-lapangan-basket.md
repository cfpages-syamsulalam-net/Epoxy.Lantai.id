---
article_id: EFL-12-05
title: "Sports Court dan Basketball Area"
slug: "epoxy-lantai-lapangan-basket"
description: "Menyusun requirement office, retail, mall, hotel, hospital, station/airport, sports, dan homes"
status: outline
publication_date: "2026-04-11"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EFL-12
primary_intent: "Menilai color/texture/use"
reader_community: "Lantai.id"
reader_address: "Kawan Lantai.id"
final_route: "/artikel/epoxy-lantai-lapangan-basket.html"
...
# Sports Court dan Basketball Area

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sports Court dan Basketball Area”
- **Reader and situation:** Menyusun requirement office, retail, mall, hotel, hospital, station/airport, sports, dan homes
- **Reader outcome:** Menyusun requirement office, retail, mall, hotel, hospital, station/airport, sports, dan homes
- **Primary intent:** Menilai color/texture/use
...
- **Scope boundary:** Sports performance needs standards.
- **Final public route:** `/artikel/epoxy-lantai-lapangan-basket.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sports Court dan Basketball Area**.
...
- **Exact Markdown to insert:** `![Ilustrasi kontraktor lantai Lapangan Basket](/wp-content/uploads/2025/08/kontraktor-lantai-Lapangan-Basket.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `kontraktor lantai Lapangan Basket` as relevant content media; no pixels were inspected.
...
- `/lapangan-basket` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/lapangan-basket/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `EFL-12-03` → `/artikel/epoxy-lantai-rumah-sakit.html` — Hospital Flooring
- `EFL-12-04` → `/artikel/epoxy-lantai-stasiun-bandara.html` — Station dan Airport Flooring
- `EFL-12-06` → `/artikel/epoxy-lantai-perumahan-bangunan.html` — Residential dan General Building Epoxy
...
- **Tie back to this article:** Keep the explanation specific to “Sports Court dan Basketball Area”.
