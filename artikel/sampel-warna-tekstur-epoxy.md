---
article_id: EFL-13-03
title: "Color, Texture, dan Slip Sample"
slug: "sampel-warna-tekstur-epoxy"
...
date_modified: null
parent_topic: EFL-13
primary_intent: "Menyetujui visual/tactile result"
reader_community: "Lantai.id"
reader_address: "Teman Lantai.id"
final_route: "/artikel/sampel-warna-tekstur-epoxy.html"
...
# Color, Texture, dan Slip Sample

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Color, Texture, dan Slip Sample”
...
- **Primary intent:** Menyetujui visual/tactile result
...
- **Scope boundary:** Slip needs test data, not touch.
- **Final public route:** `/artikel/sampel-warna-tekstur-epoxy.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Color, Texture, dan Slip Sample**.
...
- `EFL-13-01` → `/artikel/survei-area-epoxy-lantai.html` — Site Survey dan Area Schedule Epoxy
- `EFL-13-02` → `/artikel/jadwal-sistem-epoxy-lantai.html` — Thickness Zones dan System Schedule
- `EFL-13-04` → `/artikel/mockup-first-off-epoxy.html` — Mockup dan First-Off Approval
...
- **Tie back to this article:** Keep the explanation specific to “Color, Texture, dan Slip Sample”.
