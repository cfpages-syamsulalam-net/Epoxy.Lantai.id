---
article_id: EFL-13-02
title: "Thickness Zones dan System Schedule"
slug: "jadwal-sistem-epoxy-lantai"
...
date_modified: null
parent_topic: EFL-13
primary_intent: "Mengoordinasikan build-up per area"
reader_community: "Lantai.id"
reader_address: "Teman Lantai.id"
final_route: "/artikel/jadwal-sistem-epoxy-lantai.html"
...
# Thickness Zones dan System Schedule

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Thickness Zones dan System Schedule”
...
- **Primary intent:** Mengoordinasikan build-up per area
...
- **Scope boundary:** Values require approved spec.
- **Final public route:** `/artikel/jadwal-sistem-epoxy-lantai.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Thickness Zones dan System Schedule**.
...
- **Tie back to this article:** Keep the explanation specific to “Thickness Zones dan System Schedule”.
