---
article_id: EFL-01-05
title: "Siklus Project Epoxy dari Survey hingga Recoat"
slug: "siklus-proyek-epoxy-lantai"
...
date_modified: null
parent_topic: EFL-01
primary_intent: "Memahami decision stages"
reader_community: "Lantai.id"
reader_address: "Kawan Lantai.id"
final_route: "/artikel/siklus-proyek-epoxy-lantai.html"
...
# Siklus Project Epoxy dari Survey hingga Recoat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Siklus Project Epoxy dari Survey hingga Recoat”
...
- **Primary intent:** Memahami decision stages
...
- **Scope boundary:** Lifecycle detail dimiliki EFL-15.
- **Final public route:** `/artikel/siklus-proyek-epoxy-lantai.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Siklus Project Epoxy dari Survey hingga Recoat**.
...
- `EFL-01-03` → `/artikel/beda-coating-topping-screed-epoxy.html` — Epoxy Coating, Topping, Screed, dan Paint
- `EFL-01-04` → `/artikel/komponen-sistem-lantai-epoxy.html` — Komponen Sistem dari Substrate hingga Topcoat
- `EFL-01-06` → `/artikel/membaca-klaim-epoxy-lantai.html` — Cara Membaca Klaim Epoxy Lantai secara Kritis
...
- **Tie back to this article:** Keep the explanation specific to “Siklus Project Epoxy dari Survey hingga Recoat”.
